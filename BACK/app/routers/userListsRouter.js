...
router
     ...
     * @summary Get all books in a user's library by the user ID
...
router
     ...
     * @summary Get all books in a user's favorites list by the user ID
     * @param {number} id.path.required - user identifier
     * @tags USER'S LISTS
     * @return {[Book]} 200 - success response - application/json
     */
...
router
     ...
     * @summary Get all books in a user's alerts list by the user ID
     * @param {number} id.path.required - user identifier
     * @tags USER'S LISTS
     * @return {[Book]} 200 - success response - application/json
     */
