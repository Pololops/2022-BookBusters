...
cron.schedule('0 0 2 * *', async () => {
    // collect of the users with expired book, ie book in donation for more than 180 or 187 days
    ...
    if (users) {
        ...
        users.forEach(user => {
            ...
            promiseToSolve.push(transporter.sendMail({
                ...
                text: "BookBusters", // plain text body
                html: `<b>Cher(e) BookBuster,</b><br><b>Le livre "${book.title}" de "${book.author} est en donation chez BookBusters. Est il toujours disponible ? </b><br><b>Si le livre est toujours en donation, cliquez sur le lien suivant.</b><br><b>http://localhost:5000/v1/book/isbn/${user.isbn13}</b><br><b>Si le livre n'est plus dispo, pas de souci. Dans quelques jours le livre sera retiré automatique de notre site</b><br><b>Et surtout, n'hésitez pas à nous apporter d'autres livres sur BookBusters !</b><br><b>L'équipe BookBusters</b>`, // html body
            }));
        });
